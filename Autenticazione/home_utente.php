...
<div class="container mt-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
            ...
            <a href="../Componenti/visualizza_progetto.php" class="text-decoration-none text-dark">
                <div class="card card-hover shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Consulta i progetti aperti e scegli cosa supportare.</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <!-- Commenta un progetto -->
        <div class="col">
            <a href="componenti/commenta_progetto.php" class="text-decoration-none text-dark">
                <div class="card card-hover shadow-sm h-100">
                    <div class="card-body">
                        <h5 class="card-title">💬 Commenta un Progetto</h5>
                        <p class="card-text">Lascia un tuo parere o una domanda sotto i progetti.</p>
                    </div>
                </div>
            </a>
        </div>
